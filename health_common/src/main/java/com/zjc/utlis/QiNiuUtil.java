package com.zjc.utlis;

import com.google.gson.Gson;
import com.zjc.constant.MessageConstant;
...
public class QiNiuUtil {
    ...
    private static final String ACCESSKEY = "7n_yaUP628bA9Q97NV1EWFx0RQ-u9pPxPG2-fPO6";
    private static final String SECRETKEY = "CxA_QBA1APpNcqWgNRUmOleAso_Po3IR4nV_Ccmy";
    private static final String BUCKET = "myzjc";
    public static final String DOMAIN= "q0uioqe5e.bkt.clouddn.com";

    public static void main(String[] args) {
        uploadFile("F:\\img\\mm.jpg","mm1.jpg");
